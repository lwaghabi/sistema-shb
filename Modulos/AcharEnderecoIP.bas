Attribute VB_Name = "AcharEnderecoIP"
Option Explicit
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
...
Public Function PL_RedeInitialize() As Boolean

   Dim WSAD As WSADATA
   Dim success As Long
   
   PL_RedeInitialize = WSAStartup(WS_VERSION_REQD, WSAD) = IP_SUCCESS
    
End Function


Public Sub PL_RedeLinpa()
